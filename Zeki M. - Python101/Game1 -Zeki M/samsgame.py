...
player = Actor("ninjagame",(200, 580))
enemies = []
bullets = []
bombs = []
...
def draw_text():
    screen.draw.text("level " + str(level), (0,10), color="black")
    screen.draw.text("Score " + str(score), (100,10), color="black")
    screen.draw.text("Lives " + str(lives), (200,10), color="black")
